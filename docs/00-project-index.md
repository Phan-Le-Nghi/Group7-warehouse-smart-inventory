...
| AI Usage Log v1 | [`AI_USAGE_LOG.md`](AI_USAGE_LOG.md) | Việc dùng AI cá nhân đã kiểm chứng | Tất cả thành viên; Ly Na điều phối | 17 mục; có deployment re-decision Vercel/Render/Supabase, Auth + Deployment decision, Final Delivery readiness/scope-freeze reconciliation, Figma evidence reconciliation và human-verification boundary |
