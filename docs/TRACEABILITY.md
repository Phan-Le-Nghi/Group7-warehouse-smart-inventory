...
| `US-PICK-001` | full Pick; multi-location; explicit `PARTIAL_INSUFFICIENT`; negative-stock guard | Implementation-ready Technical Story Spec human-approved at `DEC-037`; no Pick code, migration or implementation test evidence yet |
